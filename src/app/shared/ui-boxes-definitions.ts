...
export const UiInventoryBoxHeightShrink = 0.8  // portion of heigth of the height allocated by above is actually used to display the inventory
export const UiInvWidthOfPsWidth  = 0.8   // portion of width for inventory, remaining width for flow arrow
