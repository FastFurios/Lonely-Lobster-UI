export const environment = {
  ...
  // msal config details
  msalConfig: {
    clientId: "65f67e5b-d0c0-4677-adf8-fc895254393a", // Azure Portal / Entra Standardverzeichnis / App Registration: Application (client) ID: it is the application id of this Angular "Lonely Lobster Frontend (DEV) 
